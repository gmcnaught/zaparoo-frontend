...
- **mister-fpga-blitter** host layer (`third_party/mister-fpga-blitter/`, built only with
  ...
  [`third_party/mister-fpga-blitter/README.md`](third_party/mister-fpga-blitter/README.md).
